...
class MyIdDirectLoginScreen extends StatefulWidget {
  const MyIdDirectLoginScreen({super.key});

  @override
  State<MyIdDirectLoginScreen> createState() => _MyIdDirectLoginScreenState();
}

class _MyIdDirectLoginScreenState extends State<MyIdDirectLoginScreen> {
...
-----END PUBLIC KEY-----''';
  ...
  Future<void> _startMyIdAuth() async {
    ...
    try {
      // 1. Backend dan BO'SH session ID olish (pasport MyID SDK'da kiritiladi)
      ...
      if (sessionId == null) {
        throw Exception('session_id topilmadi');
      }
      ...
      if (result.code == '0') {
        // Muvaffaqiyatli - MyID SDK pasport ma'lumotlarini to'pladi
        final userData = {
