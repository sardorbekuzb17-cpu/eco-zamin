    ...
    try {
        ...
        if (!code || !session_id) {
            return res.status(400).json({
                success: false,
                error: 'code va session_id majburiy',
            });
        }

        console.log('📤 VERIFY CODE: Kodni tekshirish sorov...');
        console.log(`   Code: ${code.substring(0, 20)}...`);
        console.log(`   Session ID: ${session_id}`);

        // MyID API'ga so'rov - kodni tekshirish
        ...
        console.log('✅ VERIFY CODE: Ma\'lumotlar olindi');
        ...
        res.status(200).json({
            ...
            base64_image: userData.base64_image || null,
        });
    } catch (error) {
        console.error('❌ VERIFY CODE XATOSI:');
